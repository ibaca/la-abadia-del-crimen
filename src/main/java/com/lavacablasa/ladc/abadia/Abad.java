...
class Abad extends Monje {
    ...
    private static final PosicionJuego[] posicionesPredef = {
        ...
        new PosicionJuego(ABAJO, 0xa4, 0x58, 0x00),     // posición de la primera parada durante el discurso de bienvenida
        new PosicionJuego(DERECHA, 0xa5, 0x21, 0x02),   // posición para que entremos a nuestra celda
        new PosicionJuego(DERECHA, 0x9c, 0x2a, 0x02),   // posición en la puerta de acceso de los monjes a la iglesia
        ...
        new PosicionJuego(DERECHA, 0x3a, 0x34, 0x0f)    // posición a la entrada del pasillo por el que lleva a la biblioteca
    };
...
/////////////////////////////////////////////////////////////////////////////
        ...
        if (juego.logica.momentoDia == NOCHE){
            ...
            if (estado == 0x0c){
                ...
                if (juego.logica.guillermo.posX >= 0x60){
                    ...
                    if ((contador >= 0xfa) || ((juego.logica.dia == 5) && ((juego.logica.guillermo.objetos & LLAVE1) == LLAVE1))){
                        estado = 0x0d;
                    }
                }
    ...
    void paseaPorLaAbadia()
    {
        ...
        if ((juego.logica.malaquias.aDondeVa == POS_ABAD) || (juego.logica.berengario.aDondeVa == POS_ABAD) || (juego.logica.bernardo.aDondeVa == POS_ABAD)) {
